CLASS zcl_generate_travel_data_5927 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_5927 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_22115927.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_22115927.

*   insert the new table entries
    INSERT ztravel_22115927 FROM TABLE @itab.
